...
class ConfigMenu extends MusicBeatState
{
	...
	{	
		...
		add(configText);
		add(descText);
		resetText = new FlxText(0, 20, 0, "Press the Delete Key to reset settings", 18);
		resetText.scrollFactor.set(0, 0);
		resetText.setFormat("assets/fonts/vcr.ttf", resetText.size, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
