...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'face', isPlayer:Bool = false, ?_id:Int = -1)
	{
		...
		// 	animation.add('monkey', [24, 24, 24], 0, false, isPlayer);
		// 	animation.add('cube', [24, 24, 24], 0, false, isPlayer);
		// 	animation.add('bf-poly', [25, 25, 25], 0, false, isPlayer);
		// 	animation.add('cat', [55, 54, 53], 0, false, isPlayer);
		// }
		// else{
		...
		// 	animation.add('monkey', [24], 0, false, isPlayer);
		// 	animation.add('cube', [24], 0, false, isPlayer);
		// 	animation.add('bf-poly', [25], 0, false, isPlayer);
		// }
		...
		animation.add('monster', [19, 20], 0, false, isPlayer);
		animation.add('monster-christmas', [19, 20], 0, false, isPlayer);
		animation.add('anders', [24, 25], 0, false, isPlayer);
		animation.add('cat', [26, 27], 0, false, isPlayer);
		animation.add('cube', [31, 30], 0, false, isPlayer);
		animation.add('round', [33, 32], 0, false, isPlayer);
